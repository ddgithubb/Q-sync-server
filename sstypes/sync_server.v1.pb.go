...
type SSMessage_AddNodeData struct {
	...
	Path      []uint32 `protobuf:"varint,4,rep,packed,name=path,proto3" json:"path,omitempty"`
...
func (x *SSMessage_AddNodeData) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *SSMessage_RemoveNodeData) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_sync_server_v1_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d,
	0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65,
	0x72, 0x5f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x70, 0x61, 0x72,
	...
	0x64, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52,
	...
	0x28, 0x04, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x44, 0x0a,
